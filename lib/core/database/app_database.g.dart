...
class $DocumentsTable extends Documents
  ...
  static const VerificationMeta _thumbnailKeyMeta = const VerificationMeta(
    'thumbnailKey',
  );
  @override
  ...
  DocumentRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return DocumentRow(
      ...
      thumbnailKey: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}thumbnail_key'],
      ),
...
class DocumentRow extends DataClass implements Insertable<DocumentRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || thumbnailKey != null) {
  ...
  DocumentsCompanion toCompanion(bool nullToAbsent) {
    return DocumentsCompanion(
      ...
      thumbnailKey: thumbnailKey == null && nullToAbsent
          ? const Value.absent()
          : Value(thumbnailKey),
...
final class $$PeopleTableReferences
  ...
  _documentsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.documents,
    aliasName: 'people__id__documents__person_id',
  );
                  ...
                  if (documentsRefs)
                    ...
                    >(
                      ...
                      managerFromTypedResult: (p0) =>
                          $$PeopleTableReferences(db, table, p0).documentsRefs,
...
final class $$CategoriesTableReferences
  ...
  _documentsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.documents,
    aliasName: 'categories__id__documents__category_id',
  );
...
final class $$DocumentsTableReferences
  ...
  static $PeopleTable _personIdTable(_$AppDatabase db) =>
      db.people.createAlias('documents__person_id__people__id');
  ...
  static $CategoriesTable _categoryIdTable(_$AppDatabase db) =>
      db.categories.createAlias('documents__category_id__categories__id');
...
class $$DocumentsTableTableManager
    extends
        RootTableManager<
          ...
          DocumentRow,
          PrefetchHooks Function({bool personId, bool categoryId})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({personId = false, categoryId = false}) {
            return PrefetchHooks(
              db: db,
